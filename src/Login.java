...
public class Login {
  public static void main(String[] args) {
    ...
    if (!user.equals(defaultUser)) print("Usuario incorrecto");
    else if (!password.equals(defaultPassword)) print("Contraseña incorrecta");
    else print("Inicio de sesion exitoso\n\nBienvenido " + defaultUser);
  }
